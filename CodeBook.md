# CodeBook
## This book describes the variables, the data, and any transformations or work that was performed to clean up the data
...
## To implenet steps mentioned above following must be done:
